...
import styles from "./MembershipAgreement.module.css";
      ...
      <section className={styles.articles}>
        ...
        <article>
          ...
          <p>
            ...
            ÜYELER doğrudan ya da dolaylı olarak sebep oldukları zararları ilk
            talep halinde ve herhangi bir hükme lüzum olmaksızın nakden ve
            defaten ödeyeceğini şimdiden kabul, beyan ve taahhüt ederler.
          </p>
        </article>
        <article>
        ...
        <article>
          <h1>9) SÖZLEŞMENİN FESHİ</h1>
          <p>
            İşbu üyelik sözleşmesi, Kullanıcı Site’ye üye olduğu sürece
