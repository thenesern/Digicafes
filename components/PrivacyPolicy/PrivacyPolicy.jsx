  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.articles}>
        ...
        <article>
          <h1>2. Kişisel Verilerinizin İşlenme Amaçları Ve Hukuki Sebepleri</h1>
          <p>
            ...
            görevlilerine bilgi verebilmek için; <br />
            <br />
            Üyelerimize geniş kapsamda çeşitli imkânlar sunabilmek veya bu
            imkânları sunabilecek kişi veya kurumlarla yasal çerçevede
            paylaşabilmek için; <br />
            <br /> Reklam tercihlerini analiz etmek için, 6698 sayılı KVKK ve
            ilgili ikincil düzenlemelere uygun olarak işlenecektir.
          </p>
        </article>
        <article>
          <h1>
        ...
        <article>
          <h1>4. Kişisel Verilerinizin Toplanma Şekli</h1>
          <p>
            Kişisel verileriniz,
            <br />
            <br />
            ...
            kayıtları,tarayıcı tarafından toplanan çerez verileri ile gezinme
        ...
        <article>
          <h1>5. Kişisel Verilerinizin Aktarılması</h1>
          <p>
            ...
            aktarılabilecektir. Kişisel Verileriniz; <br /> <br />
        ...
        <article>
          ...
          <p>
            ...
            kullanılmadığını öğrenme, <br></br>Yurt içinde veya yurt dışında
            kişisel verilerin aktarıldığı üçüncü kişileri bilme, <br></br>
            Kişisel verilerin eksik veya yanlış işlenmiş olması hâlinde bunların
            düzeltilmesini isteme, <br></br>
            KVKK’nun 7. maddesinde öngörülen şartlar çerçevesinde kişisel
            verilerin silinmesini veya yok edilmesini isteme, <br></br> Kişisel
            verilerin düzeltilmesi, silinmesi, yok edilmesi halinde bu
            işlemlerin, kişisel verilerin aktarıldığı üçüncü kişilere de
            bildirilmesini isteme, <br></br>İşlenen verilerin münhasıran
            otomatik sistemler vasıtasıyla analiz edilmesi suretiyle kişinin
            kendisi aleyhine bir sonucun ortaya çıkmasına itiraz etme, <br></br>
            Kişisel verilerin kanuna aykırı olarak işlenmesi sebebiyle zarara
            uğraması hâlinde zararın giderilmesini talep etme, <br></br>
            haklarına sahiptir.
          </p>
        </article>
        <article>
