    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <h5 className={styles.subHeader}>
          ...
          such as when you:
          <br></br>
          <br></br>- Visit our website at http://www.digicafes.com, or any
          website of ours that links to this privacy notice
          <br></br>
          <br></br>- Engage with us in other related ways, including any sales,
          marketing, or events <br></br>
          <br></br>Questions or concerns? <br></br>
          <br></br>Reading this privacy notice will help you understand your
          ...
          questions or concerns, please contact us at info@digicafes.com.
        </h5>
        <section className={styles.articles}>
          <article>
            ...
            email addresses mailing addresses usernames passwords contact or
            authentication data Sensitive Information. We do not process
            sensitive information. Payment Data. We may collect data necessary
            to process your payment if you make purchases, such as your payment
            instrument number (such as a credit card number), and the security
            code associated with your payment instrument. All personal
            ...
            <br></br>
            <br></br>- Log and Usage Data. Log and usage data is
            ...
            <br></br>
            <br></br>- Device Data. We collect device data such as information
            ...
            <br></br>
            <br></br> - Location Data. We collect location data such as
          ...
          <article>
            ...
            interact with our Services, including: <br></br>
            <br></br>- To facilitate account creation and authentication and
            ...
            account in working order. <br></br>
            <br></br>- To save or protect an individual&apos;s vital interest.
          ...
          <article>
            ...
            <br></br> If you are located in the EU or UK, this section applies
            to you. <br></br>
            <br></br>The General Data Protection Regulation (GDPR) and UK GDPR
            ...
            learn more. Legal Obligations. We may process your information where
            ...
            the safety of any person. <br></br>
            <br></br> If you are located in Canada, this section applies to you.
            <br></br>
            <br></br> We may process your information if you have given us
            ...
            exceptional cases, we may be legally permitted under applicable law
            to process your information without your consent, including, for
            example: If collection is clearly in the interests of an individual
            and consent cannot be obtained in a timely way For investigations
            and fraud detection and prevention For business transactions
            provided certain conditions are met If it is contained in a witness
            ...
            of the laws of Canada or a province If disclosure is required to
          ...
          <article>
            ...
            business to another company. Business Partners. We may share your
          ...
          <article>
            ...
            contact us at info@digicafes.com.
          </article>
          <article>
